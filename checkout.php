...
if (isset($_POST['place_order'])) {
    // Lưu thông tin đơn hàng vào cơ sở dữ liệu (cần bảng orders và order_details)
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO orders (user_id, address, shipping_method, payment_method, total, created_at) VALUES (?, ?, ?, ?, ?, NOW())");
        $stmt->execute([$_SESSION['user_id'], $address, $shipping, $payment, $total]);
            ...
            ?>
                <div class="checkout-item">
                    <div class="checkout-item-image">
                        <img src="images/product_<?php echo $item['id']; ?>_red.jpg" alt="<?php echo htmlspecialchars($item['name']); ?>">
                    </div>
