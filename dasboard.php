...
// Kiểm tra trạng thái đăng nhập (dùng cookie để kiểm tra)
    ...
    <main class="dashboard-content">
        <div class="dashboard-box">
            ...
            <div class="dashboard-info">
                ...
                <p><strong>Email:</strong> <?php echo isset($_COOKIE['registered_email']) ? htmlspecialchars($_COOKIE['registered_email']) : 'Chưa có thông tin'; ?></p>
            </div>
